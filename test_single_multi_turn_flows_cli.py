...
def testcase_correctintent_(single_turn, intent_list_to_test, main_test_utt, utt_map_intent):
...
def intent_indentification_check_(file_name):
    ...
    return main_intent_list

def test_log_(correct_intent_names, main_intent_list):
...
def main():
    ...
    print("\n<><><><><><><><><><> Testing begins <><><><><><><><><><>")
    single_turn = False
    L_restart, correct_intent_names_restart = testcase_correctintent_(single_turn, intent_list_to_test_restart, main_test_utt, utt_map_intent)#; print(L_restart, correct_intent_names_restart)
    single_turn = False
    L_multi, correct_intent_names_multi = testcase_correctintent_(single_turn, intent_list_to_test_multi, main_test_utt, utt_map_intent)#; print(L_restart, correct_intent_names_restart)
    single_turn = True
    ...
    print("\n\n<><><><><><><><><><> Test log <><><><><><><><><><>")
    main_intent_list = intent_indentification_check_(file_name)
    
    ################################################ Test Log ################################################
    test_log_(correct_intent_names, main_intent_list)
